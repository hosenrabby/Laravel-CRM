                    ...
                    <div class="card-body">
                        <form action="{{ url('admin/stuffPaymentMgmt/' . $spmedit->id) }}" method="post">
                            ...
                            <input type="text" name="paymentDate" id="paymentDate"
                                ...
                                value="{{ $spmedit->paymentDate }}"><br>
                            <label class="control-label">Payment Note</label><br>
                            <input type="text" name="paymentNote" id="paymentNote"
                                class="form-control @error('paymentNote') is-invalid @enderror"
                                value="{{ $spmedit->paymentNote }}"><br>
