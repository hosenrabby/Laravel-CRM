                ...
                <form class="forms-sample" action="{{ url('authorized/collectionManagement/' . $collectionManage->id) }}"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="projectId" id="projectId"
                            value="{{ $collectionManage->projectId }}"><br>

                    </div>
                    <div class="mb-3">
                        <label for="customerId" class="form-label">Customer Id</label>
                        <input type="text" class="form-control" name="customerId" id="customerId"
                            value="{{ $collectionManage->customerId }}">
                    </div>
                    <div class="mb-3">
                        <label for="collectionAmount" class="form-label">Collection Amount</label>
                        <input type="number" class="form-control" name="collectionAmount" id="collectionAmount"
                            value="{{ $collectionManage->collectionAmount }}">
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" name="collectionDate" id="collectionDate"
                            value="{{ $collectionManage->collectionDate }}">
                    </div>
                    <div class="mb-3">
                        <label for="collectionNote" class="form-label">Collection Note</label>
                        <input type="text" class="form-control" name="collectionNote" id="collectionNote"
                            value="{{ $collectionManage->collectionNote }}">
                    </div>
